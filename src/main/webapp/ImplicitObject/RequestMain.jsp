...
<a herf="./RequestWebInfo.jsp?eng=Hello&ko=안녕"> GET 방식 전송</a>
<br/>
...
<form method="post" action="RequestParameter.jsp">
	...
	성별 : <input type="radio" name="sex" value="man"/>남
			<input type="radio" name="sex" value="woman" checked="checked"/>여<br/>
	관심사항 : <input type="checkbox" name="favo" value="eco"/> 경제
			<input type="checkbox" name="favo" value="pol"/> 정치
			<input type="checkbox" name="favo" value="ent"/> 연예 <br/>
	자기소개 : <textarea rows="4" cols="30" name="intro"></textarea><br/>
	<input type="submit" value="전송하기"/>
</form>

<h2>3. HTTP header 정보읽기 </h2>
